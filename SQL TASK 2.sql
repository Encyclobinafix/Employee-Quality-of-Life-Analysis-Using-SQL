...
SELECT *,
    CASE
        WHEN 
            (CASE WHEN overall_rating > 3 THEN 1 ELSE 0 END +
             CASE WHEN work_life_balance > 3 THEN 1 ELSE 0 END +
             CASE WHEN skill_development > 3 THEN 1 ELSE 0 END +
             CASE WHEN salary_and_benefits > 3 THEN 1 ELSE 0 END +
             CASE WHEN job_security > 3 THEN 1 ELSE 0 END +
             CASE WHEN career_growth > 3 THEN 1 ELSE 0 END +
             CASE WHEN work_satisfaction > 3 THEN 1 ELSE 0 END) >= 2
        THEN 'Good'
        WHEN 
